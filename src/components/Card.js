...
function Card({card, onCardClick}) {
    ...
    return (
        <article className="element" key={card._id}>
          <img className="element__image" src={card.link} alt="Описание карточки" onClick={handleClick}/>
          <div className="element__container">
            ...
            <button className="element__button-delite" type="button" aria-label="Удалить"></button>
          </div>
        </article>)
}
export default Card